<?php $this->load->view('templates/header.php');?>
        <div class="col-lg-6">
            <div class="card">
                ...
                <strong>Patients Details Add</strong>
                </div>  
            ...
            <?php if($error=$this->session->flashdata('failed')):?>
                            ...
                            <?php endif; ?>
                <form action="<?php echo site_url('patients/patientsDetails');?>" method="post">

                    <div class="row form-group">
                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">patients  Name</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="name" name="name" placeholder="Name" class="form-control"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="number" id="age" name="age" placeholder="Age" class="form-control"></div>
                    </div>
                            ...
                            <div class="col col-md-9">
                                <div class="form-check-inline form-check">
                                    <label for="male-radio1" class="form-check-label ">
                                        <input type="radio" id="male" name="gender" value="1" class="form-check-input">male</label>
                                    <label for="female-radio2" class="form-check-label ">
                                        <input type="radio" id="female" name="gender" value="2" class="form-check-input">female</label>
                                    <label for="other-radio3" class="form-check-label ">
                                        <input type="radio" id="other" name="gender" value="3" class="form-check-input">other</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="number" id="phoneno" name="phoneno" placeholder="phone No" class="form-control"></div>
                    </div>
