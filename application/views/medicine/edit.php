<?php $this->load->view('templates/header.php');?>
        <div class="col-lg-6">
            <div class="card">
                ...
                <strong>Medicine Details Edit </strong>
                </div>  
            ...
            <?php if($error=$this->session->flashdata('failed')):?>
                            ...
                            <?php endif; ?>
                <form action="<?php echo site_url('medicine/update');?>" method="post">
                <input type="hidden" name="id" value="<?php echo $medicine['id']; ?>">
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="mname" name="mname" placeholder="Medicine Name" class="form-control"  value="<?php echo $medicine['mname'];?>"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="number" id="mprice" name="mprice" placeholder="Medicine Price" class="form-control" value="<?php echo $medicine['mprice'];?>"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="number" id="mstock" name="mstock" placeholder="Medicine Stock" class="form-control"value="<?php echo $medicine['mstock'];?>"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="date" id="manufacturardate" name="manufacturardate" placeholder="Manufacturar Date" class="form-control" value="<?php echo $medicine['manufacturardate'];?>"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="date" id="expdate" name="expdate" placeholder="Expiry Date " class="form-control" value="<?php echo $medicine['expdate'];?>"></div>
                    </div>
