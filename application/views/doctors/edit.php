...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <strong>Doctors Details Edit</strong>
                </div>  
            ...
            <?php if($error=$this->session->flashdata('failed')):?>
                            ...
                            <?php endif; ?>
                <form action="<?php echo site_url('doctors/update');?>" method="post">
                <input type="hidden" name="id" value="<?php echo $doctors['id']; ?>">
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="name" name="name" placeholder="Doctors Name" class="form-control" value="<?php echo $doctors['name'];?>"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="email" id="email" name="email" placeholder="Email" class="form-control" value="<?php echo $doctors['email'];?>"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><textarea name="address" id="address" rows="9" placeholder="Address..." class="form-control"><?php echo $doctors['address'];?></textarea></div>
                    </div>  
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="number" id="moblieno" name="moblieno" placeholder="Moblie No" class="form-control" value="<?php echo $doctors['moblieno'];?>"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="number" id="fee" name="fee" placeholder="Doctors Fee" class="form-control" value="<?php echo $doctors['fee'];?>"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="specialization" name="specialization" placeholder="Specialization" class="form-control" value="<?php echo $doctors['specialization'];?>"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="panel panel-default">
                            <?php $user=json_decode($doctors['availabletimedoctor']); 
                            // echo '<pre>';
                            // print_r($user);die;
                            ?>
                              ...
                              <div id="education_fields"></div>
                                ...
                                <?php foreach($user->availabletimedoctor as $row):?>
                                <input type="time" class="form-control" id="availabletimedoctor" name="availabletimedoctor[]" value="<?php echo $row;?>">
                                <?php endforeach;?>
                              </div>
                            </div>
                            <div class="col-sm-5 nopadding">
                              <div class="form-group">
                              <?php foreach($user->time as $row):?>
                                <input type="time" class="form-control" id="time" name="time[]" value="<?php echo $row;?>">
                                <?php endforeach;?>
                              </div>
                            </div>         
