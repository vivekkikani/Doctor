...
<footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright <i class="fa fa-copyright" aria-hidden="true"></i> 2022  Admin
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by <a href="">Techokings</a>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <script src="<?= base_url('assets/js/chartist-plugin-legend.min.js'); ?>"></script>
